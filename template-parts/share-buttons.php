<?php
/**
 * Template Part: SNS Share Buttons
 *
 * @package KNT_Media
 */
...
$share_title = rawurlencode( get_the_title() . ' | ' . get_bloginfo( 'name' ) );
?>
<div class="share-buttons">
    ...
    <a href="https://social-plugins.line.me/lineit/share?url=<?php echo $share_url; ?>"
    ...
    <button class="share-buttons__btn share-buttons__btn--copy" data-url="<?php echo esc_attr( get_permalink() ); ?>" aria-label="リンクをコピー">
